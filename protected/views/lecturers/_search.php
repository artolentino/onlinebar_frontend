...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'id_no',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'credentials'); ?>
		<?php echo $form->textArea($model,'credentials',array('rows'=>6, 'cols'=>50)); ?>
	</div>
