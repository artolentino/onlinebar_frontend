...
class ShopModule extends CWebModule
{
  ...
  // Whether the installer should install some demo data
	...
	public $orderNotificationFromEmail = 'artolentino@gmail.com';
	public $orderNotificationReplyEmail = 'artolentino@gmail.com';
	...
	public $validCountries = array('Philippines' => 'Philippines','China' => 'China','Singapore' => 'Singapore');
	...
	public $imageWidthThumb = 150;
	public $imageWidth = 300;

	public $notifyAdminEmail = 'artolentino@gmail.com';
	...
	public $loginUrl = array(
			'/user/login', 'action' => '%2525F%2525Fshop%2525Forder%2525Fcreate');
	...
	public $productImagesFolder = 'images/products'; 

	// Images uploaded by the customer (for example, for Poster Shops)
	public $uploadedImagesFolder = 'images/uploads'; 
	...
	public $payPalBusinessEmail = 'artolentino@gmail.com';
