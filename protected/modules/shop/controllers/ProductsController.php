	...
	public function actionIndex()
	{
     ...
     if(!empty($_GET['id'])) {
        ...
        $ProductCriteria = new CDbCriteria();
   		...
   		$item_count = ShopProducts::model()->count($ProductCriteria);
   		$pages = new CPagination($item_count);
        $pages->setPageSize(Yii::app()->params['listPerPage']);
        $pages->applyLimit($ProductCriteria);  // the trick is here!

        $ProductCategory = ShopCategory::model()->findByPk($_GET['id']);
       
        
        $this->render('index',array(
            //'model'=> Videos::model()->search(),
            'model'=> ShopProducts::model()->findAll($ProductCriteria),
            ...
            'pages'=>$pages,
             ...
             $ProductCategory = ShopCategory::model()->findAll();
