...
class ShopModule extends CWebModule
{
  ...
  // Whether the installer should install some demo data
        ...
        // comes in.
        public $orderNotificationEmail = true;
        ...
        public $adminLayout = 'application.themes.isecure.views.layouts.main';
        //public $layout = 'application.modules.shop.views.layouts.shop';
        public $layout = 'application.themes.isecure.views.layouts.main';
