...
<?php echo $form->errorSummary(array($customer, $address)); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($address,'title',Shop::module()->titleOptions,array('empty'=>'Please select title', )); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($address,'country',Shop::module()->validCountries,array('empty'=>'Please select country', )); ?>
