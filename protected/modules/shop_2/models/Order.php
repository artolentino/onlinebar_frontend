...
class Order extends CActiveRecord
{
	...
	{
		return array(
				array('customer_id, delivery_date, ordering_date, billing_address_id, payment_method', 'required'),
	...
	public function relations()
	{
		...
		if(Shop::module()->useWithYum)
			$relations['user'] = array(self::HAS_ONE, 'User', 'user_id', 'through' => 'customer');
	...
	public function search()
	{
		...
		if($this->user_id !== null) {
			$criteria->join = '
				...
				left join '. Shop::module()->userTable .' on shop_customer.user_id = '. Shop::module()->userTable .'.id';
				$criteria->compare(''. Shop::module()->userTable .'.id', $this->user_id);
		}
