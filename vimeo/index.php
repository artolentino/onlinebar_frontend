...
$vimeo = new phpVimeo('b7313730972c4f340aeb8c832bc0955cfcf5613b', '7cc1e66567417819efb1d170db4f906282e93da6');
...
switch ($_SESSION['vimeo_state']) {
    ...
    case 'returned':
        ...
        if ($_SESSION['oauth_access_token'] === NULL && $_SESSION['oauth_access_token_secret'] === NULL) {
            ...
            // Set the token
            $vimeo->setToken($_SESSION['60b72c5c916bea0524805af8ce19d382'], $_SESSION['2f5bb2a125537db258ba62be03ba2447e53a5635']);
            echo "";
            echo "Your oauth access token: ";
            echo $_SESSION['60b72c5c916bea0524805af8ce19d382'];
            echo "";           
            echo "Your oath access token secret: ";
            echo $_SESSION['2f5bb2a125537db258ba62be03ba2447e53a5635'];
            echo "";
        }
